...
These come from ZPrezto. ( https://github.com/sorin-ionescu/prezto/tree/master/modules/git ).
I've done a quick and dirty port of these to fish.  Not all of the commands will work, since
some need special functions.
...
None of these are ported to fish yet.
